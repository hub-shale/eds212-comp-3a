---
title: "Example: Numerical solutions to ODEs in R"
...
# DEFAULT parameters <- c(alpha = .75, beta = 0.8, delta = 0.5, gamma = 1)
parameters <- c(alpha = .75, beta = 0.8, delta = 0.5, gamma = 1.5)
